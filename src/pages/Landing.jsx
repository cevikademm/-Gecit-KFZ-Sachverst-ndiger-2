  ...
  return (
    <motion.nav initial={{ y: -40, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
      ...
      <div className="flex items-center justify-between pl-6 pr-5 py-3 gap-3">
        <a href="#" className="font-mono flex-shrink min-w-0 tracking-tight"
          style={{ color: C.text, fontWeight: 600 }}>
          {/* Mobilde kisa, sm ve uzeri tam isim */}
          <span className="text-2xl sm:hidden whitespace-nowrap">
            Gecit <span style={{ color: C.neon, textShadow: `0 0 14px ${C.glow}` }}>K</span>fz
          </span>
          <span className="hidden sm:inline text-xl md:text-2xl lg:text-3xl whitespace-nowrap">
            Gecit <span style={{ color: C.neon, textShadow: `0 0 14px ${C.glow}` }}>K</span>fz Sachverständiger
          </span>
        </a>
